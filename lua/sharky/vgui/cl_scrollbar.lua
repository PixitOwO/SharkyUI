...
function PANEL:Init()
	...
	self.btnGrip = vgui.Create('Sharky.ScrollBarGrip', self)
...
function PANEL:Paint(w, h)
	...
	draw.RoundedBox(Sharky.RoundedUI:GetInt(), w - self.btnGrip.BarScale, 0, self.btnGrip.BarScale, h, ColorAlpha(Sharky.ScrollerColor, self.BackgroundOpacity))
	return true
end
...
derma.DefineControl('Sharky.ScrollBar', 'A Scrollbar', PANEL, 'Panel')