...
function PANEL:Init()
	...
	self.OpenBarScale = 0
	self.OpenBarColor = Sharky.ComboBoxOpenBarColor
...
function PANEL:Paint(w, h)
	...
	draw.RoundedBox(Sharky.RoundedUI:GetInt(), 0, 0, w, h, self.FGColor) -- bg
